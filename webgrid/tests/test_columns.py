...
class TestColumn(object):
    ...
    def test_xls_style_setting(self):
        ...
        class TG(Grid):
            ...
            YesNoColumn(
                "C4", Person.inactive.label("yesno"), xls_style="font: bold True"
            )
    ...
    def test_number_format_xlwt_stymat_init(self):
        ...
        with mock.patch("webgrid.xlwt") as m_xlwt:
            ...
            class TG(Grid):
                NumericColumn(
                    "C1", Person.numericcol, format_as="foo", xls_num_format="bar"
                )
    ...
    def test_group_attr_error(self):
        with pytest.raises(
            ValueError, match="expected group to be a subclass of ColumnGroup"
        ):
